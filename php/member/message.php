<?php
    ...
    if(isset($_POST['text'])){
        ...
        $sql = " INSERT INTO `tfd102-g4`.MESSAGE_BOARD(CUSTOMER_ID, COMMENTS, MESSAGE_STATUS_ID, ADD_DATE) VALUES (?, ?, 1, NOW())";
    ...
    if(isset($_FILES['file'])){
        if($_FILES["file"]["error"] > 0){
            ...
            //檔案最終存放位置
            $filePath = $ServerRoot."/tfd102_g4/images/message/".$fileName;
            ...
            $sql = " INSERT INTO `tfd102-g4`.MESSAGE_BOARD(CUSTOMER_ID, MESSAGE_STATUS_ID, ADD_DATE, MESSAGE_IMG) VALUES (?, 1, NOW(),?)";
